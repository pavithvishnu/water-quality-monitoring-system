...
void GravityTDS::update()
{
	...
	this->voltage2 = this->analogValue/this->adcRange*this->aref;
	this->ecValue=(133.42*this->voltage2*this->voltage2*this->voltage2 - 255.86*this->voltage2*this->voltage2 + 857.39*this->voltage2)*this->kValue;
    ...
    switch(mode)
    {
      ...
      if(enterCalibrationFlag)
      {
         ...
         // Serial.println(ecValue);
          KValueTemp = rawECsolution/(133.42*voltage2*voltage2*voltage2 - 255.86*voltage2*voltage2 + 857.39*voltage2);  //calibrate in the  buffer solution, such as 707ppm(1413us/cm)@25^c
